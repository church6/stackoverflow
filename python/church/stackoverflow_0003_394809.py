...
'''
# @filename     :  stackoverflow_0003_394809.py
...
class Answer2:
    ...
    def code1():
        ...
        print('Answer2::code1')
        test = False
        print(('falseValue', 'trueValue')[test == True])
        test = True
        print(('falseValue', 'trueValue')[test == True])
        test = False
        assert ('falseValue', 'trueValue')[bool(test)] == 'falseValue'
        test = True
        assert ('falseValue', 'trueValue')[bool(test)] == 'trueValue'
