...
'''
# @filename     :  stackoverflow_0457_17839973.py
# @author       :  Copyright (C) Church.Zhong
# @date         :  Fri Nov 25 09:09:59 AM HKT 2022
# @title        :  Constructing pandas DataFrame from values in variables gives "ValueError: If using all scalar values, you must pass an index"
