...
'''
# @filename     :  stackoverflow_0598_26886653.py
# @author       :  Copyright (C) Church.Zhong
# @date         :  Fri Nov 25 09:09:59 AM HKT 2022
# @title        :  pandas create new column based on values from other columns / apply a function of multiple columns, row-wise
