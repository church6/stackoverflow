...
'''
# @filename     :  stackoverflow_0125_8933237.py
...
class Answer1:
    ...
    def code1():
        ...
        assert not os.path.exists(os.path.join(os.getcwd(), 'new_folder', 'file.txt'))

        assert not Path('new_folder').is_dir()
        assert not (Path.cwd() / 'new_folder' / 'file.txt').exists()
