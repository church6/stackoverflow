...
'''
# @filename     :  stackoverflow_0113_678236.py
...
class Answer1:
    ...
    def code1():
        ...
        assert '/path/to/some/file' == os.path.splitext("/path/to/some/file.txt")[0]
        print(os.path.splitext("/path/to/some/file.txt.zip.asc")[0])
        assert '/path/to/some/file.txt.zip' == os.path.splitext("/path/to/some/file.txt.zip.asc")[0]
...
class Answer2:
    ...
    def code1():
        ...
        assert 'file' ==Path('/root/dir/sub/file.ext').stem
