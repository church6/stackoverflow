...
'''
# @filename     :  stackoverflow_0083_41573587.py
...
# This is my personal recommendation for beginners: start by learning virtualenv and pip, tools which work with both Python 2 and 3 and in a variety of situations,
# and pick up other tools once you start needing them.
