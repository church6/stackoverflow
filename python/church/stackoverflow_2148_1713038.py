...
'''
# @filename     :  stackoverflow_2148_1713038.py
# @author       :  Copyright (C) Church.Zhong
# @date         :  Fri Nov 25 09:09:59 AM HKT 2022
# @title        :  super() fails with error: TypeError "argument 1 must be type, not classobj" when parent does not inherit from object
