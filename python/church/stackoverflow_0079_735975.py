...
'''
# @filename     :  stackoverflow_0079_735975.py
...
# Class 'MyClass' inherits from object, can be safely removed from bases in python3 (useless-object-inheritance)
...
class Answer1:
    ...
    def code1():
        ...
        '''
        print('Answer1::code1')
        assert 2 == MyClass.the_static_method(2)
