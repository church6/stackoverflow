...
# It has also been backported to 3.3, 3.2, 3.1, 2.7, 2.6, 2.5, and 2.4 on pypi.
...
# functional syntax
Colors2 = Enum('Colors2', ['RED', 'GREEN', 'BLUE'])
...
class Answer1:
    ...
    def code1():
        ...
        '''
        print('Answer1::code1')
        assert 1 == Colors1.RED.value
        assert 'RED' == Colors1.RED.name
        assert 1 == Colors2.RED.value
        assert 'RED' == Colors2.RED.name
