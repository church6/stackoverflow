...
'''
# @filename     :  stackoverflow_0052_72899.py
...
class Answer1:
    ...
    def code1():
        ...
        '''
        print('Answer1::code1')
        list_to_be_sorted = [{'name': 'Bart', 'age': 10}, {'name': 'Homer', 'age': 39}]
    ...
    def code2():
        ...
        '''
        print('Answer1::code2')
        list_to_be_sorted = [{'name': 'Bart', 'age': 100}, {'name': 'Homer', 'age': 39}]
        # The sorted() function takes a key= parameter
        newlist = sorted(list_to_be_sorted, key=lambda d: d['age'])
        print(newlist)

        # Alternatively, you can use operator.itemgetter instead of defining the function yourself
        newlist = sorted(list_to_be_sorted, key=itemgetter('age'))
        print(newlist)

        # For completeness, add reverse=True to sort in descending order
        newlist = sorted(list_to_be_sorted, key=itemgetter('age'), reverse=True)
        print(newlist)
