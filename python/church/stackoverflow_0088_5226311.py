...
'''
# @filename     :  stackoverflow_0088_5226311.py
...
# pip install -Iv http://sourceforge.net/projects/mysql-python/files/mysql-python/1.2.2/MySQL-python-1.2.2.tar.gz/downloa
