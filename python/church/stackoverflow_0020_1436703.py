...
'''
# @filename     :  stackoverflow_0020_1436703.py
...
'''
First, let me reiterate the main points in Alex’s post(https://stackoverflow.com/a/1436756/3798217):

1)The default implementation is useless (it’s hard to think of one which wouldn’t be, but yeah)
2)__repr__ goal is to be unambiguous
3)__str__ goal is to be readable
