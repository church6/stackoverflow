...
def work():
    ...
    urls = ['https://stackoverflow.com/questions/tagged/python?tab=Votes']
    for i in list(range(2, 61)):
        # print(i)
        urls.append(f'https://stackoverflow.com/questions/tagged/python?tab=votes&page={i}&pagesize=50')
